...
def main():
    ...
    valid_dataset = CustomDataset('/home/jovyan/mnt/external-images-pvc/ximeng/csv_files_for_load/only_big_3_families_test_dataset.csv', "/home/jovyan/scratch-shared/ximeng/resized_image"  )
    ...
    file_save_name = 'test1_Resnet50_families_300epoch'
...
def main_nn(num_epochs, working_device):
    ...
    optimizer = optim.Adam(filter(lambda p: p.requires_grad, model.parameters()), lr=0.0000005)
