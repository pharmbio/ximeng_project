...
new_file_list = list()
file_list = os.listdir("/home/jovyan/scratch-shared/ximeng/resized_image")
for i in file_list:
    i = i.split('.')[0]
...
print(newdf)
newdf.to_csv("/home/jovyan/mnt/external-images-pvc/ximeng/csv_files_for_load/AfterQC_big_3_essencial_csv_file.csv",';',index=None)
...
df.to_csv('/home/jovyan/mnt/external-images-pvc/ximeng/csv_files_for_load/AfterQC_big_3_essencial_csv_file.csv', sep=';',index=None)
