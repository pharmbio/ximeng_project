...
def main():
    ...
    #load data
    train_dataset = CustomDataset('/home/jovyan/mnt/external-images-pvc/ximeng/csv_files_for_load/families_fold_train_1.csv', "/home/jovyan/mnt/external-images-pvc/ximeng/five_channel_images"  )
    valid_dataset = CustomDataset('/home/jovyan/mnt/external-images-pvc/ximeng/csv_files_for_load/families_fold_test_1.csv', "/home/jovyan/mnt/external-images-pvc/ximeng/five_channel_images"  )
    ...
    file_save_name = '0523exp2.1_originsize_families_40epoch'
