...
train_dataset = CustomDataset("C:/Files/lab/five_channel_images/test1_train_dataset.csv", "C:/Files/lab/five_channel_images"  )
valid_dataset = CustomDataset("C:/Files/lab/five_channel_images/test1_valid_dataset.csv", "C:/Files/lab/five_channel_images"  )
test_dataset = CustomDataset("C:/Files/lab/five_channel_images/test1_test_dataset.csv", "C:/Files/lab/five_channel_images"  )
train_data_size = len(train_dataset)
valid_data_size = len(valid_dataset)
test_data_size = len(test_dataset)
train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=1, shuffle=True, num_workers=0)
valid_dataloader = torch.utils.data.DataLoader(valid_dataset, batch_size=1, shuffle=True, num_workers=0)
...
def train_and_valid(model, loss_function, optimizer, epochs=10):
    ...
    for epoch in range(epochs):
        ...
        torch.save(model, 'C:/Files/lab/'+'_model_'+str(epoch+1)+'.pt')
