...
def main():
    ...
    #load data
    train_dataset = CustomDataset('/home/jovyan/mnt/external-images-pvc/ximeng/csv_files_for_load/big_3_groups_test_dataset.csv', "/home/jovyan/scratch-shared/ximeng/five_channel_images"  )
